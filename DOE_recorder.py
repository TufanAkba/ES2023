...
if __name__ == '__main__':
    ...
    p.model.set_input_defaults('receiver.porosity',porosity)
    p.model.set_input_defaults('receiver.D_nom',d_nom, units='m')
    ...
    p.model.add_design_var('receiver.porosity', lower=0.20, upper=0.95)
    p.model.add_design_var('receiver.D_nom',lower=0.0005, upper=0.01, units='m')
    ...
    # Create a recorder
    recorder = om.SqliteRecorder('cases50.sql')
